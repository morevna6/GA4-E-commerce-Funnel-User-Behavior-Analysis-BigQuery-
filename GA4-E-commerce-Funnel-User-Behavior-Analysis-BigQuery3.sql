...
sessions as (
  select
    ...
    user_pseudo_id,
    session_id,
    any_value(if(event_name = 'session_start', source, null)) as source,
    any_value(if(event_name = 'session_start', medium, null)) as medium,
    any_value(if(event_name = 'session_start', campaign, null)) as campaign,
